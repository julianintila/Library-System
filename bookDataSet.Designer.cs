...
namespace WindowsFormsApplication2 {
    ...
    public partial class bookDataSet : global::System.Data.DataSet {
        ...
        public partial class BooksDataTable : global::System.Data.TypedTableBase<BooksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public BooksRow AddBooksRow(string BookName, string Author, int Book_ID, byte[] Image) {
...
namespace WindowsFormsApplication2.bookDataSetTableAdapters {
    ...
    public partial class BooksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Books` WHERE ((`ID` = ?) AND ((? = 1 AND `Book ID` IS NULL) OR (`Boo" +
                "k ID` = ?)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Original_ID", global::System.Data.OleDb.OleDbType.Integer, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "ID", global::System.Data.DataRowVersion.Original, false, null));
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("IsNull_Book_ID", global::System.Data.OleDb.OleDbType.Integer, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Book ID", global::System.Data.DataRowVersion.Original, true, null));
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Books` (`BookName`, `Author`, `Book ID`, `Image`) VALUES (?, ?, ?, ?" +
                ")";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Books` SET `BookName` = ?, `Author` = ?, `Book ID` = ?, `Image` = ? WHERE" +
                " ((`ID` = ?) AND ((? = 1 AND `Book ID` IS NULL) OR (`Book ID` = ?)))";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("IsNull_Book_ID", global::System.Data.OleDb.OleDbType.Integer, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Book ID", global::System.Data.DataRowVersion.Original, true, null));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WindowsFormsApplication2.Properties.Settings.Default.bookConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, BookName, Author, [Book ID], [Image] FROM Books";
        ...
        public virtual int Insert(string BookName, string Author, global::System.Nullable<int> Book_ID, byte[] Image) {
            if ((BookName == null)) {
        ...
        public virtual int Update(string BookName, string Author, global::System.Nullable<int> Book_ID, byte[] Image, int Original_ID, global::System.Nullable<int> Original_Book_ID) {
            if ((BookName == null)) {
